...
function refreshLinks(){
	...
	links=[["General Configuration","/wiki/admin/viewgeneralconfig.action","site configuration internal attachment size formatting international date title general settings",false],
	    ...
	    ["Space Permissions (Global)","/wiki/admin/permissions/viewdefaultspacepermissions.action","space permissions permission recover manage",false],
	    ...
	    ["Slack (Current Space)","/wiki/plugins/atlassian-connect/space-tools-tab.action?key="+spaceKey+"&addonKey=confluence-chats-integration&moduleKey=space-config-link","slack space",true],
	    ...
	    ["Themes (Global)","/wiki/admin/choosetheme.action","global themes theme customization custom layout space",false],
	    ...
	    ["Space Settings (Current Space)","/wiki/spaces/viewspacesummary.action?key="+spaceKey,"space settings",true],
	    ["Restriced Pages (Current Space)","/wiki/pages/listpermissionpages.action?key="+spaceKey,"restrictions restriction",true],
	    ["Templates (Current Space)","/wiki/pages/templates2/listpagetemplates.action?key="+spaceKey,"space template templates blueprint",true],
	    ["Reorder pages (Current Space)","/wiki/pages/reorderpages.action?key="+spaceKey,"reorder page pages",true],
	    ["Orphaned Pages (Current Space)","/wiki/pages/listorphanedpages.action?key="+spaceKey,"orphaned page pages",true],
	    ["Undefined Pages (Current Space)","/wiki/pages/listundefinedpages.action?key="+spaceKey,"undefined page pages",true],
	    ["Attachments (Current Space)","/wiki/spaces/listattachmentsforspace.action?key="+spaceKey,"attachment attachments space file files",true],
	    ["Trash (Current Space)","/wiki/pages/viewtrash.action?key="+spaceKey,"trash deleted delete page restore",true],
	    ["RSS Feed (Current Space)","/wiki/spaces/listrssfeeds.action?key="+spaceKey,"rss feed feeds space",true],
	    ["Themes (Current Space)","/wiki/spaces/choosetheme.action?key="+spaceKey,"space theme themes",true],
	    ["PDF Layout (Current Space)","/wiki/spaces/flyingpdf/viewpdflayoutconfig.action?key="+spaceKey,"space pdf layout",true],
	    ["Header & Footer (Current Space)","/wiki/spaces/custompagecontent.action?key="+spaceKey,"header footer header and footer space",true],
	    ["PDF Stylesheet (Current Space)","/wiki/spaces/flyingpdf/viewpdfstyleconfig.action?key="+spaceKey,"pdf stylesheet stylesheets",true],
	    ["Integrations (Current Space)","/wiki/spaces/listentitylinks.action?typeId=com.atlassian.applinks.api.application.confluence.ConfluenceSpaceEntityType&key="+spaceKey,"integrations space integration",true],
	    ["App Links (Current Space)","/wiki/spaces/listentitylinks.action?typeId=com.atlassian.applinks.api.application.confluence.ConfluenceSpaceEntityType&key="+spaceKey,"application application links application link links space link",true],
